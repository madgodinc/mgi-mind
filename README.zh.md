...
**[最新版本：v2.4.0](https://github.com/madgodinc/mgi-mind/releases/tag/v2.4.0)** · **[CHANGELOG](CHANGELOG.md)** · **[Discussions](https://github.com/madgodinc/mgi-mind/discussions)** · **[Issues](https://github.com/madgodinc/mgi-mind/issues)** · **[Contributing](CONTRIBUTING.md)**
...
- `MGIMIND_TAG=v2.4.0 curl ... | sh` — 锁定具体版本，而不是 `latest`。
...
当前版本：**2.4.0**（自 v1.0.0 起 semver 稳定）。基于 0.10.x 的审计
