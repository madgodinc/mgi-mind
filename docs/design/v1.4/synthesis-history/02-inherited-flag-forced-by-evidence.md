...
in my own archive.** Not three independent confirmations, but one source,
...
- **Quarantine:** inherited facts that fail their first in-session
  contact should not auto-quarantine, which would be too aggressive. They
...
facts as known. I would not have caught it on my own, because by definition
